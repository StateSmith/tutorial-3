...
class LightSm extends LightSmBase
{
        ...
        switch (this.stateId)
        {
            ...
            case LightSm.StateId.ROOT:
                switch (eventId)
                {
                    ...
                    case LightSm.EventId.ON_PRESS: break;
                    case LightSm.EventId.OFF_PRESS: break;
                    case LightSm.EventId.DO: break;
                }
                break;
    ...
    #OFF_enter()
    {
        ...
        // OFF behavior
        // uml: enter / { this.count++; }
        {
            // Step 1: execute action `this.count++;`
            this.count++;
        } // end of behavior for OFF
        
        // OFF behavior
        // uml: enter / { this.turnOff(); }
        {
            // Step 1: execute action `this.turnOff();`
            this.turnOff();
        } // end of behavior for OFF
    }
    ...
    #ON1_enter()
    {
        ...
        // ON1 behavior
        // uml: enter / { this.turnOn(); }
        {
            // Step 1: execute action `this.turnOn();`
            this.turnOn();
        } // end of behavior for ON1
        
        // ON1 behavior
        // uml: enter / { this.resetTimer(); }
        {
            // Step 1: execute action `this.resetTimer();`
            this.resetTimer();
        } // end of behavior for ON1
    }
    ...
    {
        // ON1 behavior
        // uml: do [this.isTimerExpired()] TransitionTo(OFF)
